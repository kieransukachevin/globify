...
/* harmony export */   "getCodeParameter": () => (/* binding */ getCodeParameter),
/* harmony export */   "loginButtonClicked": () => (/* binding */ loginButtonClicked)
/* harmony export */ });
/* harmony import */ var _styles_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/styles.css */ "./src/styles/styles.css");
/* harmony import */ var _assets_globe_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/globe.jpg */ "./src/assets/globe.jpg");
...
function loginButtonClicked() {
  return _loginButtonClicked.apply(this, arguments);
}
function _loginButtonClicked() {
  _loginButtonClicked = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var client_id, redirect_uri, state, scope, url, params;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            client_id = '3d474cad631f40028c1f3909186b0686';
...
function getCodeParameter() {
  ...
  if (paramValue) {
    ...
    var mainArea = document.getElementById('main-area-1');
    setLoadingArea(mainArea);
    axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('http://localhost:4200/code', {
...
function setLoadingArea(area) {
  // Globe image (Loading)
  var img = new Image();
  img.src = _assets_globe_jpg__WEBPACK_IMPORTED_MODULE_1__;
  img.alt = 'globe';
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n* {\n    font-family: sans-serif;\n    font-weight: normal;\n    letter-spacing: 0.08em;\n}\nh2 {\n    text-align: center;\n}\n.main-area {\n    display: grid;\n    justify-content: center;\n    align-content: center;\n    height: 100vh;\n}\n.loader {\n    display: block;\n    background-color: transparent;\n    border-style: solid;\n    border-width: 0.5em;\n    border-radius: 50%;\n    border-color: transparent;\n    animation: spin 1s infinite ;\n    height: 100px;\n    width: 100px;\n}\n@keyframes spin {\n    0% {\n        transform: rotate(0deg)\n    }\n    100% {\n        transform: rotate(360deg)\n    }\n}\n", "",{"version":3,"sources":["webpack://./src/styles/styles.css"],"names":[],"mappings":";AACA;IACI,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;AAC1B;AACA;IACI,kBAAkB;AACtB;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,qBAAqB;IACrB,aAAa;AACjB;AACA;IACI,cAAc;IACd,6BAA6B;IAC7B,mBAAmB;IACnB,mBAAmB;IACnB,kBAAkB;IAClB,yBAAyB;IACzB,4BAA4B;IAC5B,aAAa;IACb,YAAY;AAChB;AACA;IACI;QACI;IACJ;IACA;QACI;IACJ;AACJ","sourcesContent":["\n* {\n    font-family: sans-serif;\n    font-weight: normal;\n    letter-spacing: 0.08em;\n}\nh2 {\n    text-align: center;\n}\n.main-area {\n    display: grid;\n    justify-content: center;\n    align-content: center;\n    height: 100vh;\n}\n.loader {\n    display: block;\n    background-color: transparent;\n    border-style: solid;\n    border-width: 0.5em;\n    border-radius: 50%;\n    border-color: transparent;\n    animation: spin 1s infinite ;\n    height: 100px;\n    width: 100px;\n}\n@keyframes spin {\n    0% {\n        transform: rotate(0deg)\n    }\n    100% {\n        transform: rotate(360deg)\n    }\n}\n"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = __webpack_require__.p + "globe.jpg";
...
function getInfo() {
  ...
  httpRequest.open('GET', 'http://localhost:4200/main/data', true);
  httpRequest.send();
}
function setup() {
  var loginButton = document.getElementById('login-button');
  loginButton.addEventListener('click', _login__WEBPACK_IMPORTED_MODULE_1__.loginButtonClicked);
}
setup();
window.onload = getInfo;
window.onload = _login__WEBPACK_IMPORTED_MODULE_1__.getCodeParameter;
})();

/******/ })()
;
//# sourceMappingURL=bundlee23c8ddacfb5bf3a62bc.js.map